...
def init_db():
    ...
    with engine.connect() as conn:
        for col_stmt in [
            ...
            "ALTER TABLE leads ADD COLUMN enriched_email VARCHAR(255)",
            "ALTER TABLE leads ADD COLUMN enriched_phone VARCHAR(50)",
            "ALTER TABLE leads ADD COLUMN enriched_role VARCHAR(255)",
            "ALTER TABLE leads ADD COLUMN enriched_linkedin VARCHAR(255)",
            "ALTER TABLE leads ADD COLUMN enriched_company_size VARCHAR(100)",
            "ALTER TABLE leads ADD COLUMN enriched_tech_stack TEXT",
            "ALTER TABLE leads ADD COLUMN enriched_hiring_signals TEXT",
            "ALTER TABLE leads ADD COLUMN enriched_funding_signals TEXT",
            "ALTER TABLE leads ADD COLUMN enrichment_status VARCHAR(50) DEFAULT 'PENDING'",
            "ALTER TABLE leads ADD COLUMN outreach_ready BOOLEAN DEFAULT 0",
            "ALTER TABLE leads ADD COLUMN outreach_playbook TEXT",
            "ALTER TABLE leads ADD COLUMN buyer_persona VARCHAR(100)",
            "ALTER TABLE leads ADD COLUMN signal_source VARCHAR(100) DEFAULT 'qeic_crawler'",
            "ALTER TABLE leads ADD COLUMN outreach_status VARCHAR(50) DEFAULT 'UNREAD'",
            "ALTER TABLE leads ADD COLUMN intent_quality VARCHAR(50) DEFAULT 'VERIFIED REAL'",
            "ALTER TABLE leads ADD COLUMN lead_owner VARCHAR(100) DEFAULT 'Unassigned (Auto-Routed)'",
